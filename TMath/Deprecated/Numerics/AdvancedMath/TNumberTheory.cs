...
namespace TMath.Deprecated.Numerics.AdvancedMath
{
    /// <summary>
    /// A mathematical utility class providing number theory functions for generic integer numeric types.
    /// </summary>
    public static class TNumberTheory
    {
        ...
        public static IEnumerable<T> GeneratePrimesUpTo<T>(T number) where T : INumber<T>, IBinaryInteger<T>
        {
            ...
            T[] nums = TGeneration.NumberSequence(T.One, number).ToArray();
